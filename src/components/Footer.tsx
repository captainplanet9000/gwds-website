...
export default function Footer() {
  ...
  return (
    <footer className="cival" style={{ background: 'var(--color-neutral-900)', color: 'var(--color-neutral-300)' }}>
      <div data-cv-2col data-cv-footer style={{ maxWidth: 1200, margin: '0 auto', padding: '72px 28px 40px', display: 'grid', gridTemplateColumns: 'minmax(0,1.3fr) repeat(4, minmax(0,1fr))', gap: 34 }}>
        <div>
