...
import { SOURCE_RELEASES_ON_HOLD } from './release-readiness';

export const STORE_SALES_ENABLED = process.env.NEXT_PUBLIC_STORE_SALES_ENABLED === 'true' && !SOURCE_RELEASES_ON_HOLD;
