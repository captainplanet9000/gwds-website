...
export const products: Product[] = [
  {
    ...
    name: "Core Edition",
    description: "The platform, and a working VWAP + RSI agent trading on Hyperliquid out of the box. Goal-based execution, farm orchestration, 44 themes, and a plugin slot for every agent we sell.",
    longDescription: `This is the system, not a mockup of one. Connect a Hyperliquid wallet and the included VWAP + RSI agent starts placing orders — volume-weighted price bands confirmed by RSI divergence, with a hard drawdown halt.
...
Add strategies when you want them. Each agent in the store drops into the same runtime with no code changes.`,
    ...
    features: [
      "A working VWAP + RSI agent that trades Hyperliquid out of the box",
      "Goal-based execution engine — set a target, agents work toward it",
      "Multi-strategy farms with shared risk limits and a shared scratchpad",
      "Real-time P&L, positions, and order management",
      "Drawdown monitoring, correlation checks, and position sizing",
      "Agent health scoring and benchmarking",
      "44 built-in themes, or build your own",
      "Plugin system for every agent and extension in the store",
      "Full TypeScript source — 2,400+ files, nothing compiled",
      "One-click QUICK-START for macOS and Windows",
    ],
...
You get the entry logic and the drawn overlay, so you can see exactly why it took a trade.`,
  ...
  },
  {
    ...
    requiresDashboard: true,
    name: "VWAP Pro Agent",
    description: "The upgrade to the included VWAP + RSI agent: multi-timeframe bands, order-flow tracking, accumulation and distribution zones, dynamic confidence sizing.",
