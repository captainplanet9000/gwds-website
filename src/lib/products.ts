...
**Not included:** Live API keys or exchange accounts (you bring your own).`,
    ...
    image: "/images/products/focused/dashboard-hero-overview.jpg",
    images: [
      "/images/products/focused/dashboard-hero-overview.jpg",
      "/images/products/focused/agent-command-center.jpg",
      "/images/products/focused/all-farms-grid.jpg",
      "/images/products/focused/perf-stats-pnl.jpg",
      "/images/products/focused/agent-leaderboard.jpg",
      "/images/products/focused/correlation-matrix.jpg",
      "/images/products/focused/strategy-rankings.jpg",
      "/images/products/focused/position-risk-table.jpg",
      "/images/products/focused/plugin-marketplace.jpg",
      "/images/products/focused/whale-activity-header.jpg",
      "/images/products/focused/volume-profile.jpg",
      "/images/products/focused/system-health.jpg",
...
**Integrates with:** AI Trading Dashboard ($149) — copy to \`plugins/\`, restart, done.`,
    ...
    image: "/images/products/focused/meme-plugin-card.jpg",
    images: [
      "/images/products/focused/meme-plugin-card.jpg",
      "/images/products/focused/plugin-marketplace.jpg",
      "/images/products/focused/agent-command-center.jpg",
      "/images/products/focused/trade-history.jpg",
      "/images/products/focused/live-decision-stream.jpg",
    ],
...
**Integrates with:** AI Trading Dashboard ($149) — just copy the folder into \`plugins/\` and restart.`,
    ...
    image: "/images/products/focused/darvas-box-card.jpg",
    images: [
      "/images/products/focused/darvas-box-card.jpg",
      "/images/products/focused/darvas-strategy-detail.jpg",
      "/images/products/focused/agent-command-center.jpg",
      "/images/products/focused/trade-history.jpg",
      "/images/products/focused/strategy-comparison.jpg",
    ],
...
**Integrates with:** AI Trading Dashboard ($149) — copy to \`plugins/\`, restart, done.`,
    ...
    image: "/images/products/focused/elliott-wave-card.jpg",
    images: [
      "/images/products/focused/elliott-wave-card.jpg",
      "/images/products/focused/elliott-strategy-detail.jpg",
      "/images/products/focused/elliott-plugin-card.jpg",
      "/images/products/focused/agent-leaderboard.jpg",
      "/images/products/focused/live-decision-stream.jpg",
      "/images/products/focused/strategy-comparison.jpg",
    ],
...
**Integrates with:** AI Trading Dashboard ($149) — copy to \`plugins/\`, restart, done.`,
    ...
    image: "/images/products/focused/all-farms-grid.jpg",
    downloadUrl: "downloads/multi-strat-bundle-v1.0.0.zip",
    demoUrl: "https://ai-trading-dashboard-demo.vercel.app/dashboard/farms",
    images: [
      "/images/products/focused/all-farms-grid.jpg",
      "/images/products/focused/farm-orchestration-header.jpg",
      "/images/products/focused/agent-command-center.jpg",
      "/images/products/focused/perf-stats-pnl.jpg",
      "/images/products/focused/strategy-rankings.jpg",
      "/images/products/focused/correlation-matrix.jpg",
      "/images/products/focused/farm-pnl-chart.jpg",
    ],
  },
