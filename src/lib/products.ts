...
export const products: Product[] = [
  {
    ...
    stripePriceId: process.env.NEXT_PUBLIC_CORE_STRIPE_PRICE_ID || "price_1U09vdLLyk0oaesNmjX9ZSDL",
    name: "Cival Core 2.0",
    description: "A verified, safe-by-default TypeScript paper-trading operations dashboard with simulated orders, agent controls, risk views, audit history, and portable backups.",
    longDescription: `Cival Core 2.0 is a complete commercial source template for exploring a paper-trading operations workflow. It includes a polished command center, a simulated order ticket, agent controls, goals, a local audit record, and validated JSON backup and restore.

The supported release is deliberately paper-only. It contains no exchange connector, withdrawal route, private-key form, or live-order endpoint. Optional managed-hosting mode adds verified customer sign-in and row-level-secured cloud workspace persistence without changing that safety boundary.`,
    price: 99,
    wasPrice: 149,
    category: "trading",
    ...
    features: [
      "Paper-only simulated order desk",
      "Portfolio, risk, goal, and agent-control views",
      "Explicit audit events for every simulated action",
      "Validated JSON backup and restore",
      "Optional authenticated hosted mode",
      "Strict TypeScript and production build",
      "Four verified unit tests",
      "Zero production dependency vulnerabilities",
      "Vercel deployment helper and runbook",
      "Commercial single-user source licence",
    ],
    techStack: ["Next.js 16", "React 19", "TypeScript", "Zod", "Optional Supabase Auth"],
    image: "/images/products/core-v2/overview.png",
    images: [
      "/images/products/core-v2/overview.png",
      "/images/products/core-v2/paper-desk.png",
      "/images/products/core-v2/agents.png",
      "/images/products/core-v2/settings.png",
    ],
    downloadUrl: "downloads/cival-core-v2.0.0.zip",
    demoUrl: "https://cival-core-v2-template.vercel.app",
  },
  {
    id: "strategy-pack",
    legacy: true,
