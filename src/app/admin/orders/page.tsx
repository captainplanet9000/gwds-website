              ...
              <tbody>
                {orders.map((o: any) => (
                  <tr key={o.id} style={{ borderBottom: '1px solid #111' }}>
                    ...
                    <td style={{ padding: '12px' }}>
                      <span style={{ padding: '3px 10px', borderRadius: 4, fontSize: '0.65rem', fontWeight: 600, background: o.status === 'completed' ? '#10B98120' : '#F59E0B20', color: o.status === 'completed' ? '#10B981' : '#F59E0B', textTransform: 'uppercase' }}>{o.status}</span>
                    </td>
