...
import HomeHosting, { type HomeHostingPlan } from '@/components/HomeHosting';
...
export default function Home({ hostingPlans, hostingSales, trialDays }: { hostingPlans: HomeHostingPlan[]; hostingSales: boolean; trialDays: number }) {
  return (
    <div className="cival">
      <Navbar />
      <main>
        ...
        <Premise />
        <CoreEditionCard />
        <HomeHosting plans={hostingPlans} sales={hostingSales} trialDays={trialDays} />
        <AgentRail />
        <SourceShowcase />
        <EditionsStack />
        <ProofDemo />
